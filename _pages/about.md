...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**  
   ...
   *Arxiv*, 2025. (First author) [Code](https://github.com/Vicent0205/Vision4Chart)

**2024**

3. **On the Universal Truthfulness Hyperplane Inside LLMs**  
   Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He.  
   *EMNLP 2024*. (First author) [Code](https://github.com/Vicent0205/Universal_Truthfulness_Hyperplane)
